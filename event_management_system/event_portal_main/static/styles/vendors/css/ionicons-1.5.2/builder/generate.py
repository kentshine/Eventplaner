...
CSS_FOLDER_PATH = os.path.join(ROOT_PATH, 'styles')
...
def generate_css_from_scss(data):
  ...
  css_file_path = os.path.join(CSS_FOLDER_PATH, 'ionicons.styles')
  css_min_file_path = os.path.join(CSS_FOLDER_PATH, 'ionicons.min.styles')
...
def generate_component_json(data):
  ...
  d = {
    ...
    "license": "MIT",
    "styles": [
      "styles/%s.styles" % (data['name'].lower())
    ],
    "fonts": [
